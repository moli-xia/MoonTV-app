...
const SidebarClient = ({ onToggle, activePath = '/' }: SidebarProps) => {
...
const Sidebar = ({ onToggle, activePath = '/' }: SidebarProps) => {
  return (
    <Suspense fallback={<div className="w-64 h-screen bg-white/40 backdrop-blur-xl border-r border-gray-200/50 dark:bg-gray-900/70 dark:border-gray-700/50"></div>}>
      <SidebarClient onToggle={onToggle} activePath={activePath} />
    </Suspense>
  );
};
